...
# Description: Run GATK HC using scatter-gather method for failed HC taks from step 15
...
echo "$(date) : Start GATK 4 HaplotypeCaller on recalibrated BAM from bootstrapping round ${round} for ${sample}interval ${interval}" > ${log}
